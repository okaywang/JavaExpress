...
public class ThriftDoubleCodeTemplate extends AbstractThriftCodeTemplate {
	...
	public String genEncode(ThriftServiceFunc func, String space, ThriftService service) {
		...
		buf.append(formatWriteFieldBegin("success", Constants._TTYPE_DOUBLE, "0", space));
		buf.append(writeValue(space, "writeDouble", "result"));
	...
	public String genDecode(ThriftServiceFunc func, String space, ThriftService service) {
		...
		buf.append(space).append(retType + " result" + " = " + "iprot.readDouble()" + ";").append("\r\n");
	...
	public String genEncode(ThriftServiceFuncParam param, String space, ThriftService service) {
		...
		StringBuffer buf = new StringBuffer();
		buf.append(formatWriteFieldBegin(param.getParamName(), Constants._TTYPE_DOUBLE, param.getParamIndex(), space));
		buf.append(writeValue(space, "writeDouble", "(Double) args[" + index + "]"));
		buf.append(formatWriteFieldEnd(space));
		return buf.toString();
	}
	...
	public String genDecode(ThriftServiceFuncParam param, String space, ThriftService service) {
		StringBuffer buf = new StringBuffer();
		buf.append(formatIfEqual(space, new String[] { "field.type", Constants._TTYPE_DOUBLE }));
		String fieldName = param.getParamName().trim();
		buf.append(space + "\t").append("args." + fieldName + " = " + "iprot.readDouble()" + ";").append("\r\n");
	...
	public String genEncode(ThriftStructField field, String space, ThriftStruct struct) {
		...
		StringBuffer buf = new StringBuffer();
		buf.append(formatWriteFieldBegin(fieldName, Constants._TTYPE_DOUBLE, field.getFieldIndex(), space));
		buf.append(writeValue(space, "writeDouble", "this.obj." + func + "()"));
		buf.append(formatWriteFieldEnd(space));
		return buf.toString();
	}
	...
	public String genDecode(ThriftStructField field, String space, ThriftStruct struct) {
		...
		buf.append(space + "\t").append("obj." + func + "(" + "iprot.readDouble()" + ");").append("\r\n");
		buf.append(space + "} else {").append("\r\n");
		buf.append(formatSkip(space + "\t"));
